...
@SuiteClasses({DeepOclClabjectWrapperTest.class, DeepOclNavigationTests.class,
    ...
    DeepReflectiveConstraints.class, BPMN2Tests.class, Ocl2StringTests.class, MddTutorial.class,
    DeepOCLCollectionTest.class, OCLFilterTest.class, WarehouseChallengeTests.class,
    DOCLStylesTests.class, DOCLPatternTests.class})
