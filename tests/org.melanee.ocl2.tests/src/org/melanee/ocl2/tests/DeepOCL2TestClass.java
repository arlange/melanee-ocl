...
@SuiteClasses({ DeepOclClabjectWrapperTest.class, DeepOclNavigationTests.class, DeepOCLTreeVisitorTest.class,
		...
		ClosureOperationTest.class, DeepClassificationChecking.class, DeepReflectiveConstraints.class, BPMN2Tests.class,
		Ocl2StringTests.class, MddTutorial.class, DeepOCLCollectionTest.class, OCLFilterTest.class })
