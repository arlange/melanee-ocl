...
public class DeepOclNavigationTests {
  ...
  Clabject xyEntity = PLMFactory.eINSTANCE.createEntity();
  ...
  public void setUp() {
    ...
    this.l3.getContent().add(xyEntity);
    ...
    parti23.setDestination(xyEntity);
  ...
  public void firstTest() {
    DeepOclLexer oclLexer = new DeepOclLexer(
        new ANTLRInputStream("context ArnesCar \ninv test: self.$Car$.wheel"));
  ...
  public void fourthTest() {
    DeepOclLexer oclLexer = new DeepOclLexer(
        new ANTLRInputStream("context Dragster \ninv test: self.$Car$.wheel"));
    DeepOclParser parser = new DeepOclParser(new CommonTokenStream(oclLexer));
    ParseTree tree = parser.contextDeclCS();
