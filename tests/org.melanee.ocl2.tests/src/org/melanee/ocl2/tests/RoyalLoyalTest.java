...
public class RoyalLoyalTest {
	...
	public void testInv() throws IOException {
		...
		ParserInterpreter pars = new ParserInterpreter(parser.getGrammarFileName(),
				Arrays.asList(parser.getTokenNames()), Arrays.asList(parser.getRuleNames()),
				parser.getATNWithBypassAlts(), parser.getTokenStream());
