...
public interface DeepOclVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code timesDivide} labeled alternative in
  ...
  /**
   * Visit a parse tree produced by the {@code plusMinus} labeled alternative in
   * {@link DeepOclParser#infixedExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code andOrXor} labeled alternative in
   * {@link DeepOclParser#infixedExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code Message} labeled alternative in
   * {@link DeepOclParser#infixedExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code equalOperations} labeled
  ...
  /**
   * Visit a parse tree produced by the {@code prefixedExp} labeled alternative in
   * {@link DeepOclParser#infixedExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code iteratorBar} labeled alternative in
   * {@link DeepOclParser#infixedExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code implies} labeled alternative in
   * {@link DeepOclParser#infixedExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code dot} labeled alternative in
  ...
  /**
   * Visit a parse tree produced by the {@code arrow} labeled alternative in
   * {@link DeepOclParser#navigationOperatorCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code invalid} labeled alternative in
   * {@link DeepOclParser#primitiveLiteralExpCS}.
   * 
   * @param ctx
   *          the parse tree
  ...
  /**
   * Visit a parse tree produced by the {@code name} labeled alternative in
  ...
  /**
   * Visit a parse tree produced by the {@code ontologicalName} labeled
  ...
  /**
   * Visit a parse tree produced by the {@code linguisticalName} labeled
   * alternative in {@link DeepOclParser#nameExpCS}.
   * 
   * @param ctx
   *          the parse tree
