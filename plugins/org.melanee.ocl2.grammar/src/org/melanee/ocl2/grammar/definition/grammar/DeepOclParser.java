...
public class DeepOclParser extends Parser {
  ...
  public static final int T__0 = 1, T__1 = 2, T__2 = 3, T__3 = 4, T__4 = 5, T__5 = 6, T__6 = 7,
      ...
      T__57 = 58, T__58 = 59, T__59 = 60, T__60 = 61, T__61 = 62, CONTEXT = 63,
      UnaryOperatorCS = 64, InvalIDLiteralExpCS = 65, NumberLiteralExpCS = 66, INT = 67,
      BooleanLiteralExpCS = 68, NullLiteralExpCS = 69, ID = 70, WS = 71, ONESPACE = 72, STRING = 73,
      COMMENT = 74;
  public static final int RULE_contextDeclCS = 0, RULE_operationContextCS = 1,
      RULE_levelSpecificationCS = 2, RULE_bodyCS = 3, RULE_postCS = 4, RULE_preCS = 5,
      RULE_defCS = 6, RULE_typeExpCS = 7, RULE_typeLiteralCS = 8, RULE_tupleTypeCS = 9,
      RULE_tuplePartCS = 10, RULE_collectionTypeCS = 11, RULE_collectionTypeIDentifier = 12,
      RULE_primitiveTypeCS = 13, RULE_typeNameExpCS = 14, RULE_specificationCS = 15,
      RULE_expCS = 16, RULE_infixedExpCS = 17, RULE_iteratorBarExpCS = 18,
      ...
      RULE_typeLiteralExpCS = 26, RULE_collectionLiteralExpCS = 27,
      RULE_collectionLiteralPartCS = 28, RULE_tupleLiteralExpCS = 29, RULE_tupleLiteralPartCS = 30,
      RULE_selfExpCS = 31, RULE_primitiveLiteralExpCS = 32, RULE_navigatingExpCS = 33,
      RULE_navigatingSemiAgrsCS = 34, RULE_navigatingCommaArgCS = 35, RULE_navigatingArgExpCS = 36,
      RULE_navigatingBarAgrsCS = 37, RULE_navigatingArgCS = 38, RULE_indexExpCS = 39,
      RULE_nameExpCS = 40, RULE_parameterCS = 41, RULE_invCS = 42, RULE_classifierContextCS = 43,
      RULE_propertyContextDeclCS = 44, RULE_derCS = 45, RULE_initCS = 46, RULE_onespace = 47;
  public static final String[] ruleNames = { "contextDeclCS", "operationContextCS",
      "levelSpecificationCS", "bodyCS", "postCS", "preCS", "defCS", "typeExpCS", "typeLiteralCS",
      "tupleTypeCS", "tuplePartCS", "collectionTypeCS", "collectionTypeIDentifier",
      "primitiveTypeCS", "typeNameExpCS", "specificationCS", "expCS", "infixedExpCS",
      "iteratorBarExpCS", "navigationOperatorCS", "prefixedExpCS", "primaryExpCS", "nestedExpCS",
      "ifExpCS", "letExpCS", "letVariableCS", "typeLiteralExpCS", "collectionLiteralExpCS",
      "collectionLiteralPartCS", "tupleLiteralExpCS", "tupleLiteralPartCS", "selfExpCS",
      "primitiveLiteralExpCS", "navigatingExpCS", "navigatingSemiAgrsCS", "navigatingCommaArgCS",
      "navigatingArgExpCS", "navigatingBarAgrsCS", "navigatingArgCS", "indexExpCS", "nameExpCS",
      "parameterCS", "invCS", "classifierContextCS", "propertyContextDeclCS", "derCS", "initCS",
      "onespace" };

  private static final String[] _LITERAL_NAMES = { null, "':'", "'::'", "'('", "','", "')'", "'_'",
      "'body'", "'post'", "'pre'", "'def'", "'='", "'Tuple'", "'<'", "'>'", "'Collection'", "'Bag'",
      "'OrderedSet'", "'Sequence'", "'Set'", "'Boolean'", "'Integer'", "'Real'", "'ID'",
      "'UnlimitedNatural'", "'OclAny'", "'OclInvalID'", "'OclVoID'", "'/'", "'*'", "'+'", "'-'",
      "'<='", "'>='", "'<>'", "'^'", "'and'", "'or'", "'xor'", "'implies'", "'|'", "'.'", "'->'",
      "'if'", "'then'", "'else'", "'endif'", "'let'", "'in'", "'{'", "'}'", "'..'", "'self'", "'@'",
      "'\"'", "';'", "'['", "']'", "'$'", "'#'", "'inv'", "'derive'", "'init'", "'context'", null,
  ...
  private static final String[] _SYMBOLIC_NAMES = { null, null, null, null, null, null, null, null,
      ...
      null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
      null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
      null, null, null, null, null, null, null, null, null, null, "CONTEXT", "UnaryOperatorCS",
      "InvalIDLiteralExpCS", "NumberLiteralExpCS", "INT", "BooleanLiteralExpCS", "NullLiteralExpCS",
  ...
  public static class ContextDeclCSContext extends ParserRuleContext {
    ...
    public int getRuleIndex() {
      return RULE_contextDeclCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterContextDeclCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitContextDeclCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitContextDeclCS(this);
      else
  ...
  public static class OperationContextCSContext extends ParserRuleContext {
    public TerminalNode CONTEXT() {
      return getToken(DeepOclParser.CONTEXT, 0);
    }

    public List<TerminalNode> ID() {
      return getTokens(DeepOclParser.ID);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_operationContextCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterOperationContextCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitOperationContextCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitOperationContextCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final OperationContextCSContext operationContextCS() throws RecognitionException {
    ...
    try {
      ...
      enterOuterAlt(_localctx, 1);
      {
        ...
        setState(133);
        _la = _input.LA(1);
        if (((((_la - 12)) & ~0x3f) == 0 && ((1L << (_la - 12))
            & ((1L << (T__11 - 12)) | (1L << (T__14 - 12)) | (1L << (T__15 - 12))
                | (1L << (T__16 - 12)) | (1L << (T__17 - 12)) | (1L << (T__18 - 12))
                | (1L << (T__19 - 12)) | (1L << (T__20 - 12)) | (1L << (T__21 - 12))
                | (1L << (T__22 - 12)) | (1L << (T__23 - 12)) | (1L << (T__24 - 12))
                | (1L << (T__25 - 12)) | (1L << (T__26 - 12)) | (1L << (ID - 12)))) != 0)) {
          {
            setState(125);
            parameterCS();
            setState(130);
        ...
        _la = _input.LA(1);
        while ((((_la) & ~0x3f) == 0
            && ((1L << _la) & ((1L << T__6) | (1L << T__7) | (1L << T__8))) != 0)) {
          {
            setState(143);
            switch (_input.LA(1)) {
            case T__8: {
  ...
  public static class LevelSpecificationCSContext extends ParserRuleContext {
    public List<TerminalNode> NumberLiteralExpCS() {
      return getTokens(DeepOclParser.NumberLiteralExpCS);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_levelSpecificationCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterLevelSpecificationCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitLevelSpecificationCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitLevelSpecificationCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class BodyCSContext extends ParserRuleContext {
    ...
    public TerminalNode ID() {
      return getToken(DeepOclParser.ID, 0);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterBodyCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitBodyCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitBodyCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PostCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPostCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPostCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPostCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PreCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPreCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPreCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPreCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DefCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterDefCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitDefCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitDefCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TypeExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_typeExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTypeExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTypeExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTypeExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TypeLiteralCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_typeLiteralCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTypeLiteralCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTypeLiteralCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTypeLiteralCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TupleTypeCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_tupleTypeCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTupleTypeCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTupleTypeCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTupleTypeCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TuplePartCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_tuplePartCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTuplePartCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTuplePartCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTuplePartCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class CollectionTypeCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_collectionTypeCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterCollectionTypeCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitCollectionTypeCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitCollectionTypeCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class CollectionTypeIDentifierContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_collectionTypeIDentifier;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterCollectionTypeIDentifier(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitCollectionTypeIDentifier(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitCollectionTypeIDentifier(this);
      else
        return visitor.visitChildren(this);
    }
  }

  public final CollectionTypeIDentifierContext collectionTypeIDentifier()
      throws RecognitionException {
    CollectionTypeIDentifierContext _localctx = new CollectionTypeIDentifierContext(_ctx,
        getState());
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        setState(253);
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__14) | (1L << T__15) | (1L << T__16)
            | (1L << T__17) | (1L << T__18))) != 0))) {
          _errHandler.recoverInline(this);
        } else {
          consume();
  ...
  public static class PrimitiveTypeCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_primitiveTypeCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPrimitiveTypeCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPrimitiveTypeCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPrimitiveTypeCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final PrimitiveTypeCSContext primitiveTypeCS() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _la = _input.LA(1);
        if (!((((_la) & ~0x3f) == 0
            && ((1L << _la) & ((1L << T__19) | (1L << T__20) | (1L << T__21) | (1L << T__22)
                | (1L << T__23) | (1L << T__24) | (1L << T__25) | (1L << T__26))) != 0))) {
          _errHandler.recoverInline(this);
        } else {
          consume();
        }
  ...
  public static class TypeNameExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_typeNameExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTypeNameExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTypeNameExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTypeNameExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class SpecificationCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_specificationCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterSpecificationCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitSpecificationCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitSpecificationCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final SpecificationCSContext specificationCS() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        _errHandler.sync(this);
        _la = _input.LA(1);
        while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << T__11) | (1L << T__14)
            | (1L << T__15) | (1L << T__16) | (1L << T__17) | (1L << T__18) | (1L << T__19)
            | (1L << T__20) | (1L << T__21) | (1L << T__22) | (1L << T__23) | (1L << T__24)
            | (1L << T__25) | (1L << T__26) | (1L << T__39) | (1L << T__42) | (1L << T__46)
            | (1L << T__51) | (1L << T__57) | (1L << T__58))) != 0)
            || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (UnaryOperatorCS - 64))
                | (1L << (InvalIDLiteralExpCS - 64)) | (1L << (NumberLiteralExpCS - 64))
                | (1L << (BooleanLiteralExpCS - 64)) | (1L << (NullLiteralExpCS - 64))
                | (1L << (ID - 64)) | (1L << (STRING - 64)))) != 0)) {
          {
            {
              setState(270);
              infixedExpCS(0);
  ...
  public static class ExpCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TimesDivideContext extends InfixedExpCSContext {
    ...
    public TimesDivideContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTimesDivide(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTimesDivide(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTimesDivide(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PlusMinusContext extends InfixedExpCSContext {
    ...
    public PlusMinusContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPlusMinus(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPlusMinus(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPlusMinus(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class AndOrXorContext extends InfixedExpCSContext {
    ...
    public AndOrXorContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterAndOrXor(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitAndOrXor(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitAndOrXor(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class MessageContext extends InfixedExpCSContext {
    ...
    public MessageContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterMessage(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitMessage(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitMessage(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class EqualOperationsContext extends InfixedExpCSContext {
    ...
    public EqualOperationsContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterEqualOperations(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitEqualOperations(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitEqualOperations(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PrefixedExpContext extends InfixedExpCSContext {
    ...
    public PrefixedExpContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPrefixedExp(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPrefixedExp(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPrefixedExp(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class IteratorBarContext extends InfixedExpCSContext {
    ...
    public IteratorBarContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterIteratorBar(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitIteratorBar(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitIteratorBar(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class ImpliesContext extends InfixedExpCSContext {
    ...
    public ImpliesContext(InfixedExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterImplies(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitImplies(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitImplies(this);
      else
        return visitor.visitChildren(this);
    }
  }
        ...
        while (_alt != 2 && _alt != org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER) {
          if (_alt == 1) {
            ...
            _prevctx = _localctx;
            {
              ...
              case 1: {
                _localctx = new TimesDivideContext(
                    new InfixedExpCSContext(_parentctx, _parentState));
              ...
              case 2: {
                ...
                break;
              case 3: {
                _localctx = new EqualOperationsContext(
                    new InfixedExpCSContext(_parentctx, _parentState));
                ...
                _la = _input.LA(1);
                if (!((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__10) | (1L << T__12)
                    | (1L << T__13) | (1L << T__31) | (1L << T__32) | (1L << T__33))) != 0))) {
              ...
              case 5: {
                ...
                _la = _input.LA(1);
                if (!((((_la) & ~0x3f) == 0
                    && ((1L << _la) & ((1L << T__35) | (1L << T__36) | (1L << T__37))) != 0))) {
  ...
  public static class IteratorBarExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_iteratorBarExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterIteratorBarExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitIteratorBarExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitIteratorBarExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigationOperatorCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigationOperatorCS;
    }
  ...
  public static class ArrowContext extends NavigationOperatorCSContext {
    public ArrowContext(NavigationOperatorCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterArrow(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitArrow(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitArrow(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DotContext extends NavigationOperatorCSContext {
    public DotContext(NavigationOperatorCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterDot(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitDot(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitDot(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PrefixedExpCSContext extends ParserRuleContext {
    ...
    public List<TerminalNode> UnaryOperatorCS() {
      return getTokens(DeepOclParser.UnaryOperatorCS);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_prefixedExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPrefixedExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPrefixedExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPrefixedExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PrimaryExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_primaryExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPrimaryExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPrimaryExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPrimaryExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NestedExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_nestedExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNestedExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNestedExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNestedExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        do {
          ...
          _errHandler.sync(this);
          _la = _input.LA(1);
        } while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << T__11)
            | (1L << T__14) | (1L << T__15) | (1L << T__16) | (1L << T__17) | (1L << T__18)
            | (1L << T__19) | (1L << T__20) | (1L << T__21) | (1L << T__22) | (1L << T__23)
            | (1L << T__24) | (1L << T__25) | (1L << T__26) | (1L << T__39) | (1L << T__42)
            | (1L << T__46) | (1L << T__51) | (1L << T__57) | (1L << T__58))) != 0)
            || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & ((1L << (UnaryOperatorCS - 64))
                | (1L << (InvalIDLiteralExpCS - 64)) | (1L << (NumberLiteralExpCS - 64))
                | (1L << (BooleanLiteralExpCS - 64)) | (1L << (NullLiteralExpCS - 64))
                | (1L << (ID - 64)) | (1L << (STRING - 64)))) != 0));
  ...
  public static class IfExpCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterIfExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitIfExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitIfExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class LetExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_letExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterLetExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitLetExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitLetExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class LetVariableCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_letVariableCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterLetVariableCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitLetVariableCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitLetVariableCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TypeLiteralExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_typeLiteralExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTypeLiteralExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTypeLiteralExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTypeLiteralExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class CollectionLiteralExpCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterCollectionLiteralExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitCollectionLiteralExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitCollectionLiteralExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public final CollectionLiteralExpCSContext collectionLiteralExpCS() throws RecognitionException {
    ...
    try {
      enterOuterAlt(_localctx, 1);
      {
        ...
        setState(405);
        _la = _input.LA(1);
        if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << T__11) | (1L << T__14)
            | (1L << T__15) | (1L << T__16) | (1L << T__17) | (1L << T__18) | (1L << T__19)
            | (1L << T__20) | (1L << T__21) | (1L << T__22) | (1L << T__23) | (1L << T__24)
            | (1L << T__25) | (1L << T__26) | (1L << T__39) | (1L << T__42) | (1L << T__46)
            | (1L << T__51) | (1L << T__57) | (1L << T__58))) != 0)
  ...
  public static class CollectionLiteralPartCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_collectionLiteralPartCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterCollectionLiteralPartCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitCollectionLiteralPartCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitCollectionLiteralPartCS(this);
      else
        return visitor.visitChildren(this);
    }
  }

  public final CollectionLiteralPartCSContext collectionLiteralPartCS()
      throws RecognitionException {
  ...
  public static class TupleLiteralExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_tupleLiteralExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTupleLiteralExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTupleLiteralExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTupleLiteralExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class TupleLiteralPartCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_tupleLiteralPartCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterTupleLiteralPartCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitTupleLiteralPartCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitTupleLiteralPartCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class SelfExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_selfExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterSelfExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitSelfExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitSelfExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NumberContext extends PrimitiveLiteralExpCSContext {
    public TerminalNode NumberLiteralExpCS() {
      return getToken(DeepOclParser.NumberLiteralExpCS, 0);
    }

    public NumberContext(PrimitiveLiteralExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNumber(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNumber(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNumber(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class BooleanContext extends PrimitiveLiteralExpCSContext {
    public TerminalNode BooleanLiteralExpCS() {
      return getToken(DeepOclParser.BooleanLiteralExpCS, 0);
    }

    public BooleanContext(PrimitiveLiteralExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterBoolean(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitBoolean(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitBoolean(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class StringContext extends PrimitiveLiteralExpCSContext {
    public TerminalNode STRING() {
      return getToken(DeepOclParser.STRING, 0);
    }

    public StringContext(PrimitiveLiteralExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterString(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitString(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitString(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NullContext extends PrimitiveLiteralExpCSContext {
    public TerminalNode NullLiteralExpCS() {
      return getToken(DeepOclParser.NullLiteralExpCS, 0);
    }

    public NullContext(PrimitiveLiteralExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNull(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNull(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNull(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class InvalidContext extends PrimitiveLiteralExpCSContext {
    public TerminalNode InvalIDLiteralExpCS() {
      return getToken(DeepOclParser.InvalIDLiteralExpCS, 0);
    }

    public InvalidContext(PrimitiveLiteralExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterInvalid(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitInvalid(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitInvalid(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigatingExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigatingExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNavigatingExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNavigatingExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNavigatingExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigatingSemiAgrsCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigatingSemiAgrsCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNavigatingSemiAgrsCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNavigatingSemiAgrsCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNavigatingSemiAgrsCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigatingCommaArgCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigatingCommaArgCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNavigatingCommaArgCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNavigatingCommaArgCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNavigatingCommaArgCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigatingArgExpCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigatingArgExpCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNavigatingArgExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNavigatingArgExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNavigatingArgExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigatingBarAgrsCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigatingBarAgrsCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNavigatingBarAgrsCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNavigatingBarAgrsCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNavigatingBarAgrsCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NavigatingArgCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_navigatingArgCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterNavigatingArgCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitNavigatingArgCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitNavigatingArgCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class IndexExpCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterIndexExpCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitIndexExpCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitIndexExpCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class LinguisticalNameContext extends NameExpCSContext {
    ...
    public LinguisticalNameContext(NameExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterLinguisticalName(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitLinguisticalName(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitLinguisticalName(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class NameContext extends NameExpCSContext {
    ...
    public NameContext(NameExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterName(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitName(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitName(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class OntologicalNameContext extends NameExpCSContext {
    ...
    public OntologicalNameContext(NameExpCSContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterOntologicalName(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitOntologicalName(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitOntologicalName(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class ParameterCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_parameterCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterParameterCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitParameterCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitParameterCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class InvCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterInvCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitInvCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitInvCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class ClassifierContextCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_classifierContextCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterClassifierContextCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitClassifierContextCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitClassifierContextCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class PropertyContextDeclCSContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_propertyContextDeclCS;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterPropertyContextDeclCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitPropertyContextDeclCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitPropertyContextDeclCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class DerCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterDerCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitDerCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitDerCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class InitCSContext extends ParserRuleContext {
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterInitCS(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitInitCS(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitInitCS(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static class OnespaceContext extends ParserRuleContext {
    public TerminalNode ONESPACE() {
      return getToken(DeepOclParser.ONESPACE, 0);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_onespace;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).enterOnespace(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof DeepOclListener)
        ((DeepOclListener) listener).exitOnespace(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DeepOclVisitor)
        return ((DeepOclVisitor<? extends T>) visitor).visitOnespace(this);
      else
        return visitor.visitChildren(this);
    }
  }
  ...
  public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3L\u02b9\4\2\t\2\4"
