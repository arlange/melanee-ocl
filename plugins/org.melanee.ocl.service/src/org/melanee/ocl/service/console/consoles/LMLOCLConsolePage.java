...
public class LMLOCLConsolePage extends Page {
  ...
  public IItemLabelProvider tupleTypeLabelProvider = new IItemLabelProvider() {
    ...
    public String getText(Object object) {
      ...
      for (Iterator<?> iter = tupleType.oclProperties().iterator(); iter.hasNext();) {
        ...
        result.append(LMLOCLConsolePage.this.toString(tuple.getValue(next)));
  ...
  private class ClabjectOCLFactory implements IOCLFactory<Object> {
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.ocl.examples.interpreter.console.IOCLFactory#getName(
     * java.lang.Object)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.eclipse.ocl.examples.interpreter.console.IOCLFactory#createOCL
    ...
    if (context == null) {
      ...
      try {
        ...
        if (constraintLanguageService == null) {
          append(
              "No constraint language service available. Please install one via the PluginManager or enable in Melanee preferences.",
              outputDefault, false);
          return false;
        }

        print(constraintLanguageService.evaluate(context, expression), outputResults, false);
      } catch (Exception e) {
        result = false;
  ...
  String toString(Object object) {
    ...
    if (object instanceof String) {
      ...
      if (labeler == null) {
        labeler = (IItemLabelProvider) reflectiveAdapterFactory.adapt(eObject,
            IItemLabelProvider.class);
      }
