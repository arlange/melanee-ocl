...
public class LMLOCLCompletionProcessor implements IContentAssistProcessor {
   ...
   */
  private ICompletionProposal[] createCompletions(List<Choice> choices, int replacementOffset,
    ...
    for (Choice choice : choices) {
      ...
      if (choice.getDescription() != null && choice.getElement() != null && choice.getKind() != null
          && choice.getName() != null) {
        ...
        result.add(new CompletionProposal(text, replacementOffset, replacementLength, cursor, null,
            display, null, null));
      }
    }
