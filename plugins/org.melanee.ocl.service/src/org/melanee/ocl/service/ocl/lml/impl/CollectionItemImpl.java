...
public class CollectionItemImpl extends CollectionLiteralPartImpl implements
		CollectionItem,InternalEObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.CollectionItem#setItem(org.eclipse.ocl.expressions.OCLExpression)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.CollectionItem#checkItemType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
