...
import org.melanee.ocl.service.ocl.lml.CollectionItem;

/**
 * The CollectionItemImpl class
 * 
 * @author Dominik Kantner
 *
 */
public class CollectionItemImpl extends CollectionLiteralPartImpl
    implements CollectionItem, InternalEObject {

  /**
   * stores the collection item
   */
  protected OCLExpression<EObject> item;
   ...
   */
  @Override
  public OCLExpression<EObject> getItem() {
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.CollectionItem#setItem(org.eclipse.ocl.
   * expressions.OCLExpression)
   */
  @Override
  public void setItem(OCLExpression<EObject> value) {
    // TODO Auto-generated method stub
    this.item = value;
  }
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.CollectionItem#checkItemType(org.eclipse.emf.
