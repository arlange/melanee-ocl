 ...
 *
 */
public class RealLiteralExpImpl extends PrimitiveLiteralExpImpl
    implements RealLiteralExp, InternalEObject {
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.RealLiteralExp#setRealSymbol(java.lang.Double)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.RealLiteralExp#checkRealType(org.eclipse.emf.
  ...
  public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
    return ((Visitor<T, EObject, ?, ?, ?, ?, ?, ?, ?, ?>) v).visitRealLiteralExp(this);
  }
