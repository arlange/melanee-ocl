...
import org.melanee.ocl.service.ocl.lml.LoopExp;

/**
 * The LoopExpImpl class
 * @author Dominik Kantner
 *
 */
public class LoopExpImpl extends CallExpImpl implements LoopExp,InternalEObject {

	/**
	 * stores the iterator 
	 */
	protected EList<Variable<EObject,EObject>> iterator;
	
	/**
	 * stores the body
	 */
	protected OCLExpression<EObject> body;
	
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LoopExp#getBody()
	 */
	@Override
	public OCLExpression<EObject> getBody() {
		// TODO Auto-generated method stub
		return this.body;
	}

	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LoopExp#setBody(org.eclipse.ocl.expressions.OCLExpression)
	 */
	@Override
	public void setBody(OCLExpression<EObject> value) {
		// TODO Auto-generated method stub
		this.body=value;
	}
	 ...
	 */
	@Override
	public EList<Variable<EObject, EObject>> getIterator() {
		// TODO Auto-generated method stub
		if (iterator == null) {
			iterator = new EObjectContainmentEList<Variable<EObject,EObject>>(
				Variable.class, this, EcorePackage.LOOP_EXP__ITERATOR);
		}
		return iterator;
	}
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LoopExp#checkSourceCollection(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LoopExp#checkLoopVariableInit(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LoopExp#checkLoopVariableType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
