...
public class LoopExpImpl extends CallExpImpl implements LoopExp, InternalEObject {
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.LoopExp#setBody(org.eclipse.ocl.expressions.
   * OCLExpression)
   */
  @Override
  ...
  public EList<Variable<EObject, EObject>> getIterator() {
    // TODO Auto-generated method stub
    if (iterator == null) {
      iterator = new EObjectContainmentEList<Variable<EObject, EObject>>(Variable.class, this,
          EcorePackage.LOOP_EXP__ITERATOR);
    }
    return iterator;
  }
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.LoopExp#checkSourceCollection(org.eclipse.emf.
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.LoopExp#checkLoopVariableInit(org.eclipse.emf.
   * common.util.DiagnosticChain, java.util.Map)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.LoopExp#checkLoopVariableType(org.eclipse.emf.
   * common.util.DiagnosticChain, java.util.Map)
   */
  @Override
