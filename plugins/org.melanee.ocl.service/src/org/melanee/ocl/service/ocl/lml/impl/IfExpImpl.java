...
public class IfExpImpl extends OCLExpressionImpl implements IfExp, InternalEObject {
  ...
  /**
   * The cached value of the '{@link #getThenExpression() <em>Then
  ...
  /**
   * The cached value of the '{@link #getElseExpression() <em>Else
   * Expression</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.IfExp#setCondition(org.eclipse.ocl.expressions.
   * OCLExpression)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.IfExp#setThenExpression(org.eclipse.ocl.
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.IfExp#setElseExpression(org.eclipse.ocl.
   * expressions.OCLExpression)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.IfExp#checkBooleanCondition(org.eclipse.emf.
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.IfExp#checkIfType(org.eclipse.emf.common.util.
  ...
  public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
    return ((Visitor<T, EObject, ?, ?, ?, ?, ?, ?, ?, ?>) v).visitIfExp(this);
  }
