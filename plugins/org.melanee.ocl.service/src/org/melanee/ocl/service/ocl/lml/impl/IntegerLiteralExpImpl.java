 ...
 *
 */
public class IntegerLiteralExpImpl extends PrimitiveLiteralExpImpl implements IntegerLiteralExp,InternalEObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.IntegerLiteralExp#setIntegerSymbol(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.IntegerLiteralExp#setLongSymbol(java.lang.Long)
	 */
	@Override
	public void setLongSymbol(Long value) {
		integerSymbol = (int) (value & ((1L << Integer.SIZE) - 1));
		extendedIntegerSymbol = (value>> Integer.SIZE)
			+ ((integerSymbol < 0)
				? 1
				: 0);
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.IntegerLiteralExp#checkIntegerType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
