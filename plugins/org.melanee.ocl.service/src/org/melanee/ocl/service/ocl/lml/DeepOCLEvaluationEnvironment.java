...
public class DeepOCLEvaluationEnvironment
   ...
   */
  public DeepOCLEvaluationEnvironment(
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.EvaluationEnvironment#navigateProperty(java.lang.Object,
    ...
    if (property instanceof NavigationAttribute) {
      ...
      if (lastCast == null || lastCast.getDestination() != navAttribute.getClabject()) {
        ...
        if (lastCast.getSource() != null) {
          participants = DeepOCLUtilities.getAllSubtypeParticpants(navAttribute,
              lastCast.getSource());
   ...
   */
  @Override
  public Object navigateAssociationClass(EObject associationClass, EObject navigationSource,
      Object source) throws IllegalArgumentException {
    return null;
  }
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.EvaluationEnvironment#createExtentMap(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.AbstractEvaluationEnvironment#callOperation(java.lang.
  ...
  public Object callOperation(EObject operation, int opcode, Object source, Object[] args) {
    ...
    if (operation instanceof EOperation && ((EOperation) operation).getName() != null
        && ((EOperation) operation).getName()
            .equals(DeepOCLStandardLibraryUtil.OCL_IS_DEEP_TYPE_OF_NAME)) {
      if (source instanceof Clabject) {
    ...
    if (operation instanceof EOperation && ((EOperation) operation).getName() != null
        && ((EOperation) operation).getName()
            .equals(DeepOCLStandardLibraryUtil.OCL_IS_DEEP_KIND_OF_NAME)) {
      if (source instanceof Clabject) {
    ...
    if (operation instanceof EOperation && ((EOperation) operation).getName() != null
        && ((EOperation) operation).getName()
            .equals(DeepOCLStandardLibraryUtil.OCL_AS_DEEP_TYPE_NAME)) {
      if (source instanceof Clabject) {
        List<Object> types = DeepOCLUtilities.getAllTypes((Clabject) source);
        if (args.length == 1 && args[0] instanceof EObject) {
          EObject type = (EObject) args[0];
    ...
    if (operation instanceof EOperation && ((EOperation) operation).getName() != null
        && ((EOperation) operation).getName()
            .equals(DeepOCLStandardLibraryUtil.OCL_All_DEEP_INSTANCES_NAME)) {
      if (source instanceof Clabject) {
        ...
        if (args.length == 0) {
          ...
          if ((int) args[0] >= 1 && (int) args[1] > (int) args[0]) {
            ...
            while (tempDist <= (int) args[1] + 1) {
              allInstances
                  .addAll(DeepOCLUtilities.getInstancesWithDistance((Clabject) source, tempDist));
              tempDist++;
            }
            allInstances.removeAll(instances);
            return allInstances;
