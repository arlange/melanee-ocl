...
public class LetExpImpl extends OCLExpressionImpl implements LetExp,InternalEObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LetExp#setIn(org.eclipse.ocl.expressions.OCLExpression)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LetExp#setVariable(org.eclipse.ocl.expressions.Variable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.LetExp#checkLetType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
