...
import org.melanee.ocl.service.ocl.lml.LetExp;

/**
 * The LetExpImpl class
 * 
 * @author Dominik Kantner
 *
 */
public class LetExpImpl extends OCLExpressionImpl implements LetExp, InternalEObject {

  /**
   * stores the in expression
   */
  protected OCLExpression<EObject> in;

  /**
   * stores the variable
   */
  protected Variable<EObject, EObject> variable;
   ...
   */
  @Override
  public OCLExpression<EObject> getIn() {
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.LetExp#setIn(org.eclipse.ocl.expressions.
   * OCLExpression)
   */
  @Override
  public void setIn(OCLExpression<EObject> value) {
    // TODO Auto-generated method stub
    in = value;
  }
   ...
   */
  @Override
  public Variable<EObject, EObject> getVariable() {
    // TODO Auto-generated method stub
    return variable;
  }
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.LetExp#setVariable(org.eclipse.ocl.expressions.
   * Variable)
   */
  @Override
  public void setVariable(Variable<EObject, EObject> value) {
    // TODO Auto-generated method stub
    variable = value;
  }
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.LetExp#checkLetType(org.eclipse.emf.common.util.
   * DiagnosticChain, java.util.Map)
   */
  @Override
  ...
  public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
    return ((Visitor<T, EObject, ?, ?, ?, EObject, ?, ?, ?, ?>) v).visitLetExp(this);
  }
