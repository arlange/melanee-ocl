 ...
 *
 */
public class DeepOCLEnvironmentFactory extends
    AbstractEnvironmentFactory<EPackage, EObject, EObject, EObject, Enumeration, EObject, EObject, CallOperationAction, SendSignalAction, Constraint, EObject, EObject> {
   ...
   * 
   * @see
   * org.eclipse.ocl.EnvironmentFactory#loadEnvironment(org.eclipse.emf.ecore.
   * resource.Resource)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.EnvironmentFactory#createEnvironment(org.eclipse.ocl.
   * Environment)
   */
  @Override
  public Environment<EPackage, EObject, EObject, EObject, Enumeration, EObject, EObject, CallOperationAction, SendSignalAction, Constraint, EObject, EObject> createEnvironment(
   ...
   * 
   * @see
   * org.eclipse.ocl.EnvironmentFactory#createEvaluationEnvironment(org.eclipse.
   * ocl.EvaluationEnvironment)
   */
  @Override
  public EvaluationEnvironment<EObject, EObject, EObject, EObject, EObject> createEvaluationEnvironment(
   ...
   * 
   * @see
   * org.eclipse.ocl.AbstractEnvironmentFactory#getClassifier(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.AbstractEnvironmentFactory#createEvaluationVisitor(org.
   * eclipse.ocl.Environment, org.eclipse.ocl.EvaluationEnvironment,
   * java.util.Map)
   */
   ...
   * 
   * @see
   * org.eclipse.ocl.AbstractEnvironmentFactory#createOCLAnalyzer(org.eclipse.ocl.
   ...
   * @see
   * org.eclipse.ocl.AbstractEnvironmentFactory#createOCLAnalyzer(org.eclipse.ocl.
   * parser.AbstractOCLParser)
   */
  public DeepOCLAnalyzer createOCLAnalyzer(AbstractOCLParser parser) {
