 ...
 *
 */
public class DeepOCLEnvironment extends
    AbstractEnvironment<EPackage, EObject, EObject, EObject, Enumeration, EObject, EObject, CallOperationAction, SendSignalAction, Constraint, EObject, EObject> {
   ...
   * 
   * @see
   * org.eclipse.ocl.Environment#isInPostcondition(org.eclipse.ocl.expressions.
   * OCLExpression)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.Environment#defineAttribute(java.lang.Object,
   * org.eclipse.ocl.expressions.Variable, java.lang.Object)
   */
  @Override
  public Attribute defineAttribute(EObject owner, Variable<EObject, EObject> variable,
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.Environment#defineOperation(java.lang.Object,
   * java.lang.String, java.lang.Object, java.util.List, java.lang.Object)
   */
  @Override
