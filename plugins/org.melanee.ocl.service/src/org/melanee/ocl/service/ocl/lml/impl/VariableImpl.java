 ...
 *
 */
public class VariableImpl implements Variable, InternalEObject {
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.Variable#setInitExpression(org.eclipse.ocl.
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.expressions.Variable#setRepresentedParameter(java.lang.
   * Object)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.Variable#checkInitType(org.eclipse.emf.common.
  ...
  public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
    // TODO Auto-generated method stub
    return ((Visitor<T, EObject, ?, ?, ?, EObject, ?, ?, ?, ?>) v).visitVariable(this);
  }
