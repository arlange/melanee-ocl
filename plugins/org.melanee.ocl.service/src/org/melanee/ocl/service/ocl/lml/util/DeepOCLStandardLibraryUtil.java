...
/**
 * DeepOCLStandardLibrary which provides additional OCL operations which are
 * necessary in deep models
 * 
...
public final class DeepOCLStandardLibraryUtil {
  ...
  public static List<EObject> createAnyTypeOperations(DeepOCLEnvironment lmlEnvironment) {
    ...
    UMLReflection<EPackage, EObject, EObject, EObject, Enumeration, EObject, EObject, CallOperationAction, SendSignalAction, Constraint> uml = lmlEnvironment
        .getUMLReflection();

    result.add(createBinaryOperation(uml, stdlib.getT(), OCL_AS_DEEP_TYPE_NAME, stdlib.getOclType(),
        "typespec"));
    result.add(createBinaryOperation(uml, stdlib.getBoolean(), OCL_IS_DEEP_TYPE_OF_NAME,
        stdlib.getOclType(), "typespec"));
    result.add(createBinaryOperation(uml, stdlib.getBoolean(), OCL_IS_DEEP_KIND_OF_NAME,
        stdlib.getOclType(), "typespec"));
  ...
  public static List<EObject> createTypeTypeOperations(DeepOCLEnvironment lmlEnvironment) {
    ...
    result.add(createBinaryOperation(uml, stdlib.getSet(), OCL_All_INSTANCES_NAME,
        stdlib.getInteger(), "levelDistance"));
    result.add(createTernaryOperation(uml, stdlib.getSet(), OCL_All_INSTANCES_NAME,
        stdlib.getInteger(), "levelDistance1", stdlib.getInteger(), "levelDistance2"));
    result.add(createUnaryOperation(uml, stdlib.getSet(), OCL_All_DEEP_INSTANCES_NAME));
    result.add(createBinaryOperation(uml, stdlib.getSet(), OCL_All_DEEP_INSTANCES_NAME,
        stdlib.getInteger(), "levelDistance"));
    result.add(createTernaryOperation(uml, stdlib.getSet(), OCL_All_DEEP_INSTANCES_NAME,
        stdlib.getInteger(), "levelDistance1", stdlib.getInteger(), "levelDistance2"));
   ...
   * @return
   */
  private static EObject createBinaryOperation(
      ...
      EObject resultType, String name, EObject paramType, String paramName) {
  ...
  private static EObject createTernaryOperation(
      UMLReflection<EPackage, EObject, EObject, EObject, Enumeration, EObject, EObject, CallOperationAction, SendSignalAction, Constraint> uml,
      EObject resultType, String name, EObject param1Type, String param1Name, EObject param2Type,
      String param2Name) {
   ...
   * @return
   */
  private static EObject createUnaryOperation(
      UMLReflection<EPackage, EObject, EObject, EObject, Enumeration, EObject, EObject, CallOperationAction, SendSignalAction, Constraint> uml,
      EObject resultType, String name) {
