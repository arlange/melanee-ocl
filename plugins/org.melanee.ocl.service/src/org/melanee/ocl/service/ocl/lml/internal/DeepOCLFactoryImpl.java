...
public class DeepOCLFactoryImpl implements OCLFactory, OCLFactoryWithHiddenOpposite {
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.ecore.utilities.OCLFactoryWithHiddenOpposite#
   ...
   * 
   * @see
   * org.eclipse.ocl.utilities.OCLFactory#createCollectionType(java.lang.Object)
   */
  @SuppressWarnings("unchecked")
  @Override
   ...
   * 
   * @see
   * org.eclipse.ocl.utilities.OCLFactory#createCollectionType(org.eclipse.ocl.
   * expressions.CollectionKind, java.lang.Object)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ocl.utilities.OCLFactory#createOrderedSetType(java.lang.Object)
   */
  @SuppressWarnings("unchecked")
  @Override
  public <C, O> OrderedSetType<C, O> createOrderedSetType(C elementType) {
    org.melanee.ocl.service.ocl.lml.OrderedSetType result = new OrderedSetTypeImpl(
        (EObject) elementType);
   ...
   * 
   * @see
   * org.eclipse.ocl.utilities.OCLFactory#createSequenceType(java.lang.Object)
   */
  @SuppressWarnings("unchecked")
  @Override
  public <C, O> SequenceType<C, O> createSequenceType(C elementType) {
    org.melanee.ocl.service.ocl.lml.SequenceType result = new SequenceTypeImpl(
        (EObject) elementType);
   ...
   * (non-Javadoc)
   * 
   * @see org.eclipse.ocl.utilities.OCLFactory#createSignalMessageType(java.lang.
   * Object)
   */
  @Override
   ...
   * 
   * @see
   * org.eclipse.ocl.utilities.OCLFactory#createOperationMessageType(java.lang.
   * Object)
   */
  @Override
