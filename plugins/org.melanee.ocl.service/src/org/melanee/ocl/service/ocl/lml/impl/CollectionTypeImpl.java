...
public class CollectionTypeImpl  extends EDataTypeImpl implements CollectionType {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.types.CollectionType#checkCollectionTypeName(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.types.CollectionType#checkNoInvalidValues(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
	...
	public EList<EObject> oclOperations() {
		...
		case SET_LITERAL :
			if(operations==null || operations.isEmpty()){
				operations=	ECollections.asEList(OCLStandardLibraryUtil.createSetOperations(new DeepOCLEnvironmentFactory().createEnvironment()));
				  // create a new factory with new environment , may be later use already existing env
			}	
			return operations;
		case ORDERED_SET_LITERAL :
			if(operations==null || operations.isEmpty()){
				operations=	ECollections.asEList(OCLStandardLibraryUtil.createOrderedSetOperations(new DeepOCLEnvironmentFactory().createEnvironment()));
				  // create a new factory with new environment , may be later use already existing env
			}	
			return operations;
		case BAG_LITERAL :
			if(operations==null || operations.isEmpty()){
				operations=	ECollections.asEList(OCLStandardLibraryUtil.createBagOperations(new DeepOCLEnvironmentFactory().createEnvironment()));
				  // create a new factory with new environment , may be later use already existing env
			}	
			return operations;
		...
		case SEQUENCE_LITERAL :
			if(operations==null || operations.isEmpty()){
				operations=	ECollections.asEList(OCLStandardLibraryUtil.createSequenceOperations(new DeepOCLEnvironmentFactory().createEnvironment()));
				  // create a new factory with new environment , may be later use already existing env
			}	
			return operations;
		...
		default :
			if(operations==null || operations.isEmpty()){
				operations=	ECollections.asEList(OCLStandardLibraryUtil.createCollectionOperations(new DeepOCLEnvironmentFactory().createEnvironment()));
				  // create a new factory with new environment , may be later use already existing env
			}	
			return operations;
