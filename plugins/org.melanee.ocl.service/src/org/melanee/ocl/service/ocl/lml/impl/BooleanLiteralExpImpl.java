...
public class BooleanLiteralExpImpl extends PrimitiveLiteralExpImpl implements
		BooleanLiteralExp,InternalEObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.BooleanLiteralExp#setBooleanSymbol(java.lang.Boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.BooleanLiteralExp#checkBooleanType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
