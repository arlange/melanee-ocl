...
import org.melanee.ocl.service.ocl.lml.BooleanLiteralExp;

/**
 * The BooleanLiteralExpImpl class
 * 
 * @author Dominik Kantner
 *
 */
public class BooleanLiteralExpImpl extends PrimitiveLiteralExpImpl
    implements BooleanLiteralExp, InternalEObject {

  /**
   * The default boolean symbol
   */
  protected static final Boolean BOOLEAN_SYMBOL_EDEFAULT = null;

  /**
   * stores the boolean symbol
   */
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.BooleanLiteralExp#setBooleanSymbol(java.lang.
   * Boolean)
   */
  @Override
  public void setBooleanSymbol(Boolean value) {
    // TODO Auto-generated method stub
    this.booleanSymbol = value;
  }
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.BooleanLiteralExp#checkBooleanType(org.eclipse.
  ...
  public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
    return ((Visitor<T, EObject, ?, ?, ?, ?, ?, ?, ?, ?>) v).visitBooleanLiteralExp(this);
  }
