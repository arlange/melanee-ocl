...
import org.melanee.ocl.service.ocl.lml.VariableExp;


/**
 * The VariableExpImpl class
 * @author Dominik Kantner
 *
 */
public class VariableExpImpl implements VariableExp,InternalEObject {
	...
	/**
	 * stores the referred Variable
	 */
	protected Variable<EObject, EObject> referredVariable;
	/* (non-Javadoc)
	 ...
	 */
	@Override
	public Variable<EObject, EObject> getReferredVariable() {
		// TODO Auto-generated method stub
		return this.referredVariable;
	}

	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.VariableExp#setReferredVariable(org.eclipse.ocl.expressions.Variable)
	 */
	@Override
	public void setReferredVariable(Variable<EObject, EObject> value) {
		this.referredVariable=value;
		
	}

	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.VariableExp#checkVarType(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
