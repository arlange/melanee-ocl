...
public class VariableExpImpl implements VariableExp, InternalEObject {
  ...
  public <T, U extends Visitor<T, ?, ?, ?, ?, ?, ?, ?, ?, ?>> T accept(U v) {
    return ((Visitor<T, EObject, ?, ?, ?, EObject, ?, ?, ?, ?>) v).visitVariableExp(this);
  }
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.VariableExp#setReferredVariable(org.eclipse.ocl.
   ...
   * 
   * @see
   * org.eclipse.ocl.expressions.VariableExp#checkVarType(org.eclipse.emf.common.
