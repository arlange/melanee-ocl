...
public class OperationCallExpImpl implements OperationCallExp,InternalEObject {
	...
	public EList<OCLExpression<EObject>> getArgument() {
		...
		if (argument == null) {
			argument = new EObjectContainmentEList<OCLExpression<EObject>>(
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.OperationCallExp#setReferredOperation(java.lang.Object)
	 */
	@Override
	...
	public int getOperationCode() {
		// TODO Auto-generated method stub
			...
			//later maybe differentiation between any and typetype //like OperatioCallExpImpl of ecore
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.OperationCallExp#checkArgumentsConform(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ocl.expressions.OperationCallExp#checkArgumentCount(org.eclipse.emf.common.util.DiagnosticChain, java.util.Map)
	 */
	@Override
