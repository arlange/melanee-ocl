 ...
 * </p>
 * <ul>
 * <li>{@link org.melanee.ocl2.models.definition.constraint.Constraint#getExpression
 * <em>Expression</em>}</li>
 * <li>{@link org.melanee.ocl2.models.definition.constraint.Constraint#getMessage
 * <em>Message</em>}</li>
 * <li>{@link org.melanee.ocl2.models.definition.constraint.Constraint#getSeverity
 * <em>Severity</em>}</li>
 * <li>{@link org.melanee.ocl2.models.definition.constraint.Constraint#getLevel
 * <em>Level</em>}</li>
 * </ul>
 *
...
public interface Constraint extends AbstractConstraint {
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Expression</em>' containment reference list isn't
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Message</em>' attribute isn't clear, there really
   ...
   * begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Severity</em>' attribute isn't clear, there really
   * should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * 
   ...
   * <em>Level</em>}' containment reference. <!-- begin-user-doc --> <!--
   * end-user-doc -->
   * 
   * @param value
   ...
   *        body='String result = \"\";\n\t\tfor (Expression e :
   *        this.getExpression()) {\n\t\t\tif (e instanceof
   *        org.melanee.ocl2.models.definition.constraint.Pointer)
   *        {\n\t\t\t\tresult +=
   *        ((org.melanee.ocl2.models.definition.constraint.Pointer)
   *        e).getPointer().getName();\n\t\t\t}\n\t\t\tif (e instanceof
   *        org.melanee.ocl2.models.definition.constraint.Text) {\n\t\t\t\tresult
   *        += ((org.melanee.ocl2.models.definition.constraint.Text)
   *        e).getText();\n\t\t\t}\n\t\t}\n\t\treturn result;'"
   * @generated
   */
