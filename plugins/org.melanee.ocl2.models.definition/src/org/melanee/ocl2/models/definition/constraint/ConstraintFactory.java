...
public interface ConstraintFactory extends EFactory {
   ...
   * @generated
   */
  ConstraintFactory eINSTANCE = org.melanee.ocl2.models.definition.constraint.impl.ConstraintFactoryImpl
      .init();
  ...
  /**
   * Returns a new object of class '<em>Post Constraint</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Pre Constraint</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Body Constraint</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Init Constraint</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>Pointer</em>'. <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * 
