 ...
 * </p>
 * <ul>
 * <li>{@link org.melanee.ocl2.models.definition.constraint.impl.PointerImpl#getPointer
 * <em>Pointer</em>}</li>
 * </ul>
 *
 * @generated
...
public class PointerImpl extends ExpressionImpl implements Pointer {
      ...
      if (pointer != oldPointer) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              ConstraintPackage.POINTER__POINTER, oldPointer, pointer));
      }
    }
    return pointer;
  }
  ...
  public void setPointer(Element newPointer) {
    ...
    pointer = newPointer;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ConstraintPackage.POINTER__POINTER,
          oldPointer, pointer));
  }
