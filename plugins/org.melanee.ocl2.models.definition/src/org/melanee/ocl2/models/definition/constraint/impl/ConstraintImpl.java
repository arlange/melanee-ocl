 ...
 * </p>
 * <ul>
 *   <li>{@link org.melanee.ocl2.models.definition.constraint.impl.ConstraintImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.melanee.ocl2.models.definition.constraint.impl.ConstraintImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link org.melanee.ocl2.models.definition.constraint.impl.ConstraintImpl#getSeverity <em>Severity</em>}</li>
 *   <li>{@link org.melanee.ocl2.models.definition.constraint.impl.ConstraintImpl#getLevel <em>Level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConstraintImpl extends AbstractConstraintImpl implements Constraint {
	...
	public EList<Expression> getExpression() {
		if (expression == null) {
			expression = new EObjectContainmentEList<Expression>(Expression.class, this, ConstraintPackage.CONSTRAINT__EXPRESSION);
		}
		return expression;
	}
	...
	public void setMessage(String newMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintPackage.CONSTRAINT__MESSAGE, oldMessage, message));
	}
	...
	public void setSeverity(Severity newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintPackage.CONSTRAINT__SEVERITY, oldSeverity, severity));
	}
	...
	public NotificationChain basicSetLevel(Level newLevel, NotificationChain msgs) {
		...
		level = newLevel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ConstraintPackage.CONSTRAINT__LEVEL, oldLevel, newLevel);
	...
	public void setLevel(Level newLevel) {
		if (newLevel != level) {
			...
			if (level != null)
				msgs = ((InternalEObject)level).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ConstraintPackage.CONSTRAINT__LEVEL, null, msgs);
			if (newLevel != null)
				msgs = ((InternalEObject)newLevel).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ConstraintPackage.CONSTRAINT__LEVEL, null, msgs);
			msgs = basicSetLevel(newLevel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ConstraintPackage.CONSTRAINT__LEVEL, newLevel, newLevel));
	}
