...
public class ConstraintPackageImpl extends EPackageImpl implements ConstraintPackage {
   ...
   * 
   * <p>
   * This method is used to initialize {@link ConstraintPackage#eINSTANCE} when
  ...
  public static ConstraintPackage init() {
    ...
    ConstraintPackageImpl theConstraintPackage = (ConstraintPackageImpl) (EPackage.Registry.INSTANCE
        .get(eNS_URI) instanceof ConstraintPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI)
            : new ConstraintPackageImpl());
  ...
  public void initializePackageContents() {
    ...
    initEReference(getConstraint_Expression(), this.getExpression(), null, "expression", null, 0,
        -1, Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstraint_Message(), ecorePackage.getEString(), "message", null, 0, 1,
        Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getConstraint_Severity(), this.getSeverity(), "severity", null, 0, 1,
        Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
        IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getConstraint_Level(), this.getLevel(), null, "level", null, 0, 1,
        Constraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
        !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEOperation(getConstraint__GetText(), ecorePackage.getEString(), "getText", 0, 1, IS_UNIQUE,
        IS_ORDERED);

    initEClass(deriveConstraintEClass, DeriveConstraint.class, "DeriveConstraint", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(postConstraintEClass, PostConstraint.class, "PostConstraint", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(preConstraintEClass, PreConstraint.class, "PreConstraint", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(definitionConstraintEClass, DefinitionConstraint.class, "DefinitionConstraint",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(invariantConstraintEClass, InvariantConstraint.class, "InvariantConstraint",
        !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(bodyConstraintEClass, BodyConstraint.class, "BodyConstraint", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(initConstraintEClass, InitConstraint.class, "InitConstraint", !IS_ABSTRACT,
        !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEClass(pointerEClass, Pointer.class, "Pointer", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getPointer_Pointer(), thePLMPackage.getElement(), null, "pointer", null, 0, 1,
        Pointer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
        IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(levelEClass, Level.class, "Level", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getLevel_StartLevel(), ecorePackage.getEInt(), "startLevel", null, 0, 1,
        Level.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
        !IS_DERIVED, IS_ORDERED);
    initEAttribute(getLevel_EndLevel(), ecorePackage.getEInt(), "endLevel", null, 0, 1, Level.class,
        !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
